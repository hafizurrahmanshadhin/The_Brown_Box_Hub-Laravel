                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="{{ route('dashboard') }}" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset($systemSetting->logo ?? 'frontend/images/logo.png') }}"
                    ...
                    <div class="dropdown ms-sm-3 header-item">
                        <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span
                                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ ucfirst(Auth::user()->firstName) . ' ' . ucfirst(Auth::user()->lastName) ?? '' }}</span>
                                    <span
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                            <h6 class="dropdown-header">
                                {{ 'Welcome ' . ucfirst(Auth::user()->firstName) . ' ' . ucfirst(Auth::user()->lastName) . '!' ?? '' }}
                            </h6>
