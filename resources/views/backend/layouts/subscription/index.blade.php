                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('subscription.index') }}">Table</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">All Subscription List</h5>
                            {{-- <a href="{{ route('subscription.create') }}" class="btn btn-primary btn-sm" id="addNewPage">Add
                                New Subscription</a> --}}
                        </div>
                        <div class="card-body">
                            <table id="datatable"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="column-content">Deadline</th>
                                        <th class="column-content">Feature</th>
...
@push('scripts')
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('subscription.status', ':id') }}';
            $.ajax({
                type: "GET",
