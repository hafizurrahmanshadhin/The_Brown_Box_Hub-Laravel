...
Route::get('/login/facebook', [SocialiteController::class, 'FacebookRedirect'])->name('facebook-login');
Route::get('/login/facebook/callback', [SocialiteController::class, 'FacebookCallback']);
